...
export default function ChatArea(props) {
    ...
    const { img, username, reply=true, replyingTo, handleaddComments ,className} = props
    ...
    return (
        <div className={cn('bg-white shadow-sm mx-5 md:mx-0 dark:text-black text-base px-5 py-4 flex flex-col-reverse md:flex-row rounded-md gap-6  bottom-0',className)}>
