...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
      <h1 className="text-4xl font-bold text-white mb-12">UI/functional Challenges</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <Link href="/infinite-comment-chat">
          <div className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:bg-red-100">
            <h2 className="text-2xl font-semibold mb-2 text-red-700">Infinite Comment Chat</h2>
            <p className="text-gray-700">Check out the infinite comment chat.</p>
          </div>
        </Link>
        <Link href="/age-calculator">
          <div className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:bg-indigo-100">
            <h2 className="text-2xl font-semibold mb-2 text-indigo-700">Age Calculator</h2>
            <p className="text-gray-700">Calculate your exact age in years, months, and days.</p>
          </div>
        </Link>
      </div>
    </div>
